...
Methodology note: taxonomy labels come from the source dataset. Selecting credentials, personal, health and finance as a sensitivity subset is a project-specific analytical choice, not a legal classification. Other categories, including Location, Identifier and Message, may also carry privacy risks. Schema parameters indicate requested fields, not confirmed runtime transmission.
