...
A sixth, supplementary finding — whether plugins disclose what they collect in their actual privacy policies — comes from a separate audit dataset (see **Data Sources & Attribution** below): across 308 comparable parameters, **90.6% are never disclosed** in the plugin's privacy policy at all.
...
- **Main dataset**: [`gpt-data-exposure`](<!-- TODO: add exact GitHub URL -->) — 12,811 parameter records collected by 4,592 GPT plugins. <!-- credit original dataset authors here -->
- **Privacy-policy audit dataset** (`backend/final_results/`): produced during an earlier internship at the University of Bologna, not generated by this project's own analysis pipeline — used as-is for Research Question 6.
